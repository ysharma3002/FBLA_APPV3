...
List<String> eventsImage = ['image/SLC.png', 'image/MODnew.png', 'image/NLC.png'];
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Text(pendingTasksName[index],style: TextStyle(fontSize: 20, color: Colors.black, fontWeight: FontWeight.bold),),
                )
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: Text(eventsName[index],style: TextStyle(fontSize: 20, color: Colors.black, fontWeight: FontWeight.bold),),
